...
from data_factory.datasets import ERA5, EarthGraph, PTDataset
...
def train(local_rank, args):
    ...
    start_epoch, start_step, min_loss = load_model(model.module, optimizer, lr_scheduler, path=SAVE_PATH / 'latest.pt')
    if local_rank == 0:
    ...
    val_dataset = PTDataset(training=False, validation=True)
